...
class DemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demo" do
    assert_difference('Demo.count') do
      post demos_url, params: { demo: { email: @demo.email, message: @demo.message, name: @demo.name } }
    end
  ...
  test "should update demo" do
    patch demo_url(@demo), params: { demo: { email: @demo.email, message: @demo.message, name: @demo.name } }
